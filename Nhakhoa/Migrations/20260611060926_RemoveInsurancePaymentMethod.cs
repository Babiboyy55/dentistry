...
{
    /// <inheritdoc />
    public partial class RemoveInsurancePaymentMethod : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { true, "bi-person-badge", "patient_portal", "Cấp tài khoản Patient Portal", "Admin", 13 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 26,
                columns: new[] { "ModuleIcon", "ModuleKey", "ModuleName", "Role", "SortOrder" },
                values: new object[] { "bi-person-badge", "patient_portal", "Cấp tài khoản Patient Portal", "Doctor", 13 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 36,
                columns: new[] { "IsAllowed", "ModuleIcon", "ModuleKey", "ModuleName", "SortOrder" },
                values: new object[] { true, "bi-receipt", "invoice", "Tạo hóa đơn & thu tiền", 10 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 37, true, "bi-clipboard2-data", "patient_admin", "Thông tin hành chính bệnh nhân", "Receptionist", 11 },
                    { 38, false, "bi-box-seam", "medicine_inventory", "Quản lý kho thuốc", "Receptionist", 12 },
                    { 39, true, "bi-person-badge", "patient_portal", "Cấp tài khoản Patient Portal", "Receptionist", 13 }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 5, "INSURANCE", null, null, false, true, null, "Bảo hiểm y tế", null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 24,
                columns: new[] { "ModuleIcon", "ModuleKey", "ModuleName", "SortOrder" },
                values: new object[] { "bi-box-seam", "medicine_inventory", "Quản lý kho thuốc", 12 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 36,
                columns: new[] { "IsAllowed", "ModuleIcon", "ModuleKey", "ModuleName", "SortOrder" },
                values: new object[] { false, "bi-box-seam", "medicine_inventory", "Quản lý kho thuốc", 12 });
